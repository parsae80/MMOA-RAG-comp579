...
class CustomPPOTrainer_S(PPOTrainer, Trainer):
    r"""
    Inherits PPOTrainer.
    """
    ...
    def __init__(
        ...
        # # 因为只有selector和generator两个模块的更新，因此bs为正常值
    ...
    def ppo_train(self, resume_from_checkpoint: Optional[str] = None) -> None:
        ...
        for step in tqdm(range(max_steps), disable=not self.is_local_process_zero()):
            ...
            for idx in range(0, self.config.batch_size, self.config.mini_batch_size):  # 因为有selector和generator两个模块的更新，因此bs扩大一倍，所以这里需要 // 2
                ...
                responses.extend(mini_batch_selector_answers) # 不更新generator 只更新selector
                ...
                # responses.extend(mini_batch_generator_answers) # 不更新generator 只更新selector
                ...
                # rewards.extend(mini_batch_rewards) # 不更新generator 只更新selector
