...
generator_model_path = '/root/paddlejob/workspace/env_run/rag/LLaMA-Factory/models/llama3-8b/{}/selector_and_generator/ppo_5_07'.format(dataset_name)
...
for i in tqdm(range(0, len(selector_messages_list), batch_size)):
    ...
    for answer in answers_batch:
        number_answer = extract_digits(answer, K_candidate)
...
# 保存答案为jsonl
with open(save_results_path+'/ppo_5_07epochs_val.jsonl', 'w') as file: # 
