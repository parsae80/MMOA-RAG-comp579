...
# generator_model_path = '/root/paddlejob/workspace/env_run/rag/LLaMA-Factory/models/llama3-8b/{}/qr_selector_and_generator/sft_2'.format(dataset_name)
...
# 保存答案为jsonl
with open(save_results_path+'/LLM_wo_RAG.jsonl', 'w') as file: # sft_2_g.jsonl
