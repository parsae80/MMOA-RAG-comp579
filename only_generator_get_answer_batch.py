...
generator_model_path = '/root/paddlejob/workspace/env_run/rag/LLaMA-Factory/models/llama3-8b/hotpotqa/selector_and_generator/ppo_3'
...
for i in tqdm(range(0, len(generator_messages_list), batch_size)):
    ...
    answers_batch = answers_batch = batch_get_response(model, tokenizer, messages_batch)
    # print(answers_batch)
...
# 保存答案为jsonl
with open(save_results_path+'/ppo_3_1epoch_val.jsonl', 'w') as file: # 
