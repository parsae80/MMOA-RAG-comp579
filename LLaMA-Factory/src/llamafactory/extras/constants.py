...
# Register your Tiny LLaMA
register_model_group(
    models={
        "tiny-llama": {
            DownloadSource.DEFAULT: "/content/LLaMA-Factory/models/tinyllama",  # wherever you unpacked it
        },
    },
    template="tiny",  # or whatever prompt template you want to use
)