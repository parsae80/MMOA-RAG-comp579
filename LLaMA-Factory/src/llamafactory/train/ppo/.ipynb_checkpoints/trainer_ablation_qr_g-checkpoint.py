...
class CustomPPOTrainer_Ablation_QR_G(PPOTrainer, Trainer):
    r"""
    Inherits PPOTrainer.
    """
    ...
    def ppo_train(self, resume_from_checkpoint: Optional[str] = None) -> None:
        ...
        for step in tqdm(range(max_steps), disable=not self.is_local_process_zero()):
            ...
            if step < CRITIC_STEP:
                ...
                if step % QR_STEP == 0:
                    num += 1
                if step % SELECTOR_STEP == 0 and step > 0:
                    num += 1
            ...
            if step < 7:
                print(step, 'time consuming: {} seconds'.format(inference_end_time - inference_start_time))
            ...
            if step < 7:
                print(step, 'time consuming: {} seconds'.format(train_end_time - train_start_time))
