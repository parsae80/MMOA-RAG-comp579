...
class CustomPPOTrainer_SG(PPOTrainer, Trainer):
    r"""
    Inherits PPOTrainer.
    """
    ...
    def get_answer_dict(self, answers_path):
        ...
        for ans_pair in answers_pair:
            ...
            question_golden_answer_dict[ans_pair['question'].replace(" ", "")] = ans_pair['answer']  # hotpotqa
    ...
    def ppo_train(self, resume_from_checkpoint: Optional[str] = None) -> None:
        ...
        answers_path = '/root/paddlejob/workspace/env_run/rag/data/hotpotqa/train_top_k_docs.jsonl'
        ...
        for step in tqdm(range(max_steps), disable=not self.is_local_process_zero()):
            ...
            for idx in range(0, self.config.batch_size // 2, self.config.mini_batch_size):  # 因为有selector和generator两个模块的更新，因此bs扩大一倍，所以这里需要 // 2
                ...
                # rewards.extend(mini_batch_rewards + 0.5*mini_batch_rewards_selctor_aindoc)
