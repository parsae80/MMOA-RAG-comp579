...
top_k_docs_path = '/root/paddlejob/workspace/env_run/rag/data/hotpotqa/train_top_k_docs.jsonl'
...
# 保存答案为json
with open(save_results_path+'/hotpotqa_train_sft_selector_generator_data.json', 'w') as file:
    json.dump(selector_and_generator_sft_list, file)

# # 保存答案为json
# with open(save_results_path+'/hotpotqa_train_ppo_selector_generator_data.json', 'w') as file:
#     json.dump(selector_and_generator_sft_list, file)
